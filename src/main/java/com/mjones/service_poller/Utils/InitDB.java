...
public class InitDB {
    public static void main(String[] args) {
        ...
        database.query("CREATE TABLE IF NOT EXISTS SERVICES (id TEXT PRIMARY KEY NOT NULL, url TEXT NOT NULL, name TEXT NOT NULL, created DATETIME NOT NULL, lastUpdated DATETIME NOT NULL);")
            .onComplete(res -> {
                if (res.succeeded()) {
